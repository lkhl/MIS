...
from .transformer_helper import BaseDecodeHead, resize
...
class SwinTransfomerSegHead(BaseDecodeHead):
    ...
    def __init__(self, upsample='x1', interpolate_mode='bilinear', **kwargs):
        ...
        self.up_conv1 = nn.Sequential(
            ...
            nn.GroupNorm(1, self.out_channels // 2), nn.GELU())
        ...
        self.up_conv2 = nn.Sequential(
            ...
            nn.GroupNorm(1, self.out_channels // 4), nn.GELU())
