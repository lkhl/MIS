    ...
    def multi_head_attention_forward(
        ...
        if self.rpe and rpe:
            ...
            assert (src_len == self.window_size[0] * self.window_size[1]
                    and tgt_len == self.window_size[0] *
                    self.window_size[1]), f'src{src_len}, tgt{tgt_len}, window{self.window_size[0]}'
            ...
            attn_output_weights = attn_output_weights.view(
                bsz, num_heads, tgt_len, src_len) + relative_position_bias.unsqueeze(0)
