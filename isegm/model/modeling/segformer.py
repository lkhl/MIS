...
from mmcv.cnn import Conv2d, ConvModule, build_activation_layer, build_norm_layer, constant_init, \
    normal_init, trunc_normal_init
from mmcv.cnn.bricks.drop import build_dropout
from mmcv.cnn.bricks.transformer import MultiheadAttention
from mmcv.runner import BaseModule, ModuleList, Sequential, _load_checkpoint

from .transformer_helper import BACKBONES, HEADS, BaseDecodeHead, PatchEmbed, get_root_logger, \
    nchw_to_nlc, nlc_to_nchw, resize
...
class MixVisionTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        assert pretrain_style in ['official',
                                  'mmcls'], 'we only support official weights or mmcls weights.'
    ...
    def init_weights(self):
        if self.pretrained is None:
            ...
            state_dict['layers.0.0.projection.weight'] = torch.cat(
                [ori_proj_weight, ori_proj_weight], dim=1)
