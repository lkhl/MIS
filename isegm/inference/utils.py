...
from isegm.data.datasets import BerkeleyDataset, BraTSDataset, DavisDataset, GrabCutDataset, \
    HARDDataset, OAIZIBDataset, PascalVocDataset, SBDEvaluationDataset, ssTEMDataset
...
def compute_noc_metric(all_ious, iou_thrs, max_clicks=20):
    ...
    for iou_thr in iou_thrs:
        scores_arr = np.array([_get_noc(iou_arr, iou_thr) for iou_arr in all_ious], dtype=np.int)
